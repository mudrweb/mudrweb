...
/**
 * AdminModule menuItem2 presenter.
 *
 * @author     Zippo
 * @package    AdminModule
 */
class Item2Presenter extends AdminPresenter {
    ...
    public function renderDefault() {	  
        // get menuItem data
        $menuItem = $this->db_menuItems->getMenuItemById($this->user->getId(),2);                
        if ($menuItem) {
            ...
            throw new \Nette\Application\BadRequestException('Unable to load menuItem 2 (AdminModule - menuItem2 presenter).', 404);
        }
    }
