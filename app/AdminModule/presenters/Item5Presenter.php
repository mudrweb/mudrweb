...
/**
 * AdminModule menuItem5 presenter.
 *
 * @author     Zippo
 * @package    AdminModule
 */
class Item5Presenter extends AdminPresenter {
    ...
    public function renderDefault() {	  
        // get menuItem data
        $menuItem = $this->db_menuItems->getMenuItemById($this->user->getId(),5);                
        if ($menuItem) {
            ...
            throw new \Nette\Application\BadRequestException('Unable to load menuItem 5 (AdminModule - menuItem5).', 404);
        }
    }
