...
/**
 * AdminModule menuItem4 presenter.
 *
 * @author     Zippo
 * @package    AdminModule
 */
class Item4Presenter extends AdminPresenter {
    ...
    public function renderDefault() {	  
        // get menuItem data
        $menuItem = $this->db_menuItems->getMenuItemById($this->user->getId(),4);                
        if ($menuItem) {
            ...
            throw new \Nette\Application\BadRequestException('Unable to load menuItem 4 (AdminModule - menuItem4 presenter).', 404);
        }
    }
