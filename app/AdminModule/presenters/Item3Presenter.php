...
/**
 * AdminModule menuItem3 presenter.
 *
 * @author     Zippo
 * @package    AdminModule
 */
class Item3Presenter extends AdminPresenter {
    ...
    public function renderDefault() {	  
        // get menuItem data
        $menuItem = $this->db_menuItems->getMenuItemById($this->user->getId(),3);                
        if ($menuItem) {
            ...
            throw new \Nette\Application\BadRequestException('Unable to load menuItem 3 (AdminModule - menuItem3 presenter).', 404);
        }
    }
