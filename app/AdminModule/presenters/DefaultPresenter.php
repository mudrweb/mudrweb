...
//                ->addRule(Form::FILLED, 'Musíte zadat klíčová slova stránky.')                                
    ...
    {   
        ...
        if ($data->headerImage == 'default') {
            ...
            // update its content
            $updatedIndexContent = "#header { background-image: url(\".." . $data->headerImageData . "\"); width: 800px; height: 150px; background-size: auto 150px; background-repeat: no-repeat; padding: 0px; margin: 0 auto }";
