...
/**
 * AdminModule menuItem1 presenter.
 *
 * @author     Zippo
 * @package    AdminModule
 */
class Item1Presenter extends AdminPresenter {
    ...
    public function renderDefault() {	  
        // get menuItem data
        $menuItem = $this->db_menuItems->getMenuItemById($this->user->getId(),1);             
        if ($menuItem) {
            ...
            throw new \Nette\Application\BadRequestException('Unable to load menuItem 1 (AdminModule - menuItem1 presenter).', 404);
        }
    }     
