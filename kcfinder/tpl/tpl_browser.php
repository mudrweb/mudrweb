...
<div id="right">
    <div id="toolbar">
        <div>
        <?php 
//            $images_dir = $this->getDir();
//            $images_dir_size = dirSize($images_dir);
//            echo $images_dir_size;
//            if ($images_dir_size <= 51200) {
        ?> 
        
        <a href="kcact:upload" id="upload_mod"><?php echo $this->label("Upload") ?></a>      
